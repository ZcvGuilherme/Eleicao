...
public class EleicaoDeputadoFederal {

    private static final int TOTAL_CADEIRAS = 5; // Número padrão de cadeiras
    private Map<String, Integer> votosPartidos; // Usando um Map para armazenar votos por partido
    private List<Candidato> candidatos; // Lista de candidatos

    // Construtor que recebe a lista de candidatos
    public EleicaoDeputadoFederal(List<Candidato> candidatos) {
    ...
    public static void main(String[] args) {
        // Gera uma lista de candidatos e cria uma instância da eleição para deputados federais
        List<Candidato> candidatos = GeradorEleicao.gerarEleicao().getCandidatos();
        EleicaoDeputadoFederal eleicao = new EleicaoDeputadoFederal(candidatos); // Sem passar o número de cadeiras
