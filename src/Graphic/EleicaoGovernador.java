...
public class EleicaoGovernador {
    ...
    public void calcularResultadoEleicao() {
        ...
        if (vencedor != null) {
            System.out.println("O vencedor para Governador é: " + vencedor.getNome() + " com " + maxVotos + " votos."); // Exibe o vencedor e seus votos
        }
    }

    public static void main(String[] args) {
        List<Candidato> candidatos = GeradorEleicao.gerarEleicao().getCandidatos(); // Gera a lista de candidatos
        EleicaoGovernador eleicao = new EleicaoGovernador(candidatos); // Cria uma nova instância da eleição
