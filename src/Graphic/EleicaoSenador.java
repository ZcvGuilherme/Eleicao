...
public class EleicaoSenador {

    private static final int TOTAL_CADEIRAS = 4; // Número padrão de cadeiras
    ...
    public EleicaoSenador(List<Candidato> candidatos) {
    ...
    public static void main(String[] args) {
        // Gera uma lista de candidatos e cria uma instância da eleição para senadores
        List<Candidato> candidatos = GeradorEleicao.gerarEleicao().getCandidatos();
        EleicaoSenador eleicao = new EleicaoSenador(candidatos); // Sem passar o número de cadeiras
